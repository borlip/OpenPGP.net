...
namespace OpenPGPTest.Core
{
    ...
    public class Crc24ComputerTest
    {
        ...
        {
            TestComputeCrc("3F214365876616AB15387D5D59", 0xBA0568);
            TestComputeCrc("89003F0305013E978A669E02D8AE8DFD6EDE11027520009E2B90532BFD46E8FF1305758BE8DEC71C2C50FCCB009F6F6D5A91A80B89B7D570A6FE382BDEC5951426A6CD", 0x5982EA);
        }
        ...
        [Test]
        public void TestComputeCrcSplit()
        {
            RunTestComputeCrcSplit("3F21", "436587", "6616AB15", "387D5D59", 0xBA0568);
            RunTestComputeCrcSplit("89003F030501", "3E978A669E02D8AE", "8DFD6EDE11027520009E2B90532BFD46", "E8FF1305758BE8DEC71C2C50FCCB009F6F6D5A91A80B89B7D570A6FE382BDEC5951426A6CD", 0x5982EA);
        }
        ...
        [Test]
        public void TestComputeCrcTextStrings()
        {
            RunTestComputeCrcTextStrings("hello world", 0xB03CB7);
            RunTestComputeCrcTextStrings("Hello world", 0xEDAB02);
            RunTestComputeCrcTextStrings("123456789", 0x21CF02);
        }

        private static void RunTestComputeCrcTextStrings(string input, long expected)
        {
